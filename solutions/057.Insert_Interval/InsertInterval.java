...
public static void main(String[] args) {
        ...
        itvs.add(new Interval(1,2));
        itvs.add(new Interval(3,5));
        itvs.add(new Interval(6,7));
        itvs.add(new Interval(8,10));
        itvs.add(new Interval(12,16));
        System.out.println(s.insert(itvs, new Interval(4,9)));
}
